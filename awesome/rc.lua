...
terminal = os.getenv("TERMINAL") or "terminology"
...
mytextclock = wibox.widget.textclock("%a %b %d, %I:%M", 7)
...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag({ "Web", "Term", "Dev", "4", "5", "6", "7", "Snd", "IM" }, s, awful.layout.layouts[1])
	...
	s.mywibox:setup {
		...
		{ -- Right widgets
			...
			mywidgets.volume(),
			mywidgets.battery,
			mywidgets.base.sectionstart,
			mytextclock,
			mywidgets.base.sectionend,
			mykeyboardlayout,
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey }, "Down", function () awful.util.spawn("xbacklight -dec 15") end),
	awful.key({ modkey }, "Up", function () awful.util.spawn("xbacklight -inc 15") end),
	...
	awful.key({ "Shift" }, "XF86AudioLowerVolume", function () awful.util.spawn("pamixer --decrease 5 --allow-boost") end),
	awful.key({ "Shift" }, "XF86AudioRaiseVolume", function () awful.util.spawn("pamixer --increase 5 --allow-boost") end),
	awful.key({ }, "XF86AudioMute", function () awful.util.spawn("pamixer --toggle-mute") end),
	awful.key({ modkey }, ",", function () awful.util.spawn("pamixer --decrease 5") end),
	awful.key({ modkey }, ".", function () awful.util.spawn("pamixer --increase 5") end),
	awful.key({ modkey, "Shift" }, ",", function () awful.util.spawn("pamixer --decrease 5 --allow-boost") end),
	awful.key({ modkey, "Shift" }, ".", function () awful.util.spawn("pamixer --increase 5 --allow-boost") end),
	awful.key({ modkey }, "/", function () awful.util.spawn("pamixer --toggle-mute") end),
